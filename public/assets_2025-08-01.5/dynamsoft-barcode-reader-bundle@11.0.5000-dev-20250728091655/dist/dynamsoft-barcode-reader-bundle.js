...
var a = ()=>{}
var wasmImports = {
  /** @export */ CreateDirectoryFetcher: a,
  /** @export */ DCP_CreateInstance: a,
  /** @export */ DCP_CreateParsedResult: a,
  /** @export */ DCP_DestroyInstance: a,
  /** @export */ DCP_GetUsingModule: a,
  /** @export */ DCP_InitSettings: a,
  /** @export */ DCP_Parse: a,
  /** @export */ DDN_ConvertElement: a,
  /** @export */ DDN_CreateDDNResult: a,
  /** @export */ DDN_CreateDDNResultItem: a,
  /** @export */ DDN_CreateIntermediateResultUnits: a,
  /** @export */ DDN_CreateParameters: a,
  /** @export */ DDN_CreateTargetRoiDefConditionFilter: a,
  /** @export */ DDN_CreateTaskAlgEntity: a,
  /** @export */ DDN_HasSection: a,
  /** @export */ DDN_ReadTaskSetting: a,
  /** @export */ DLR_ConvertElement: a,
  /** @export */ DLR_CreateBufferedCharacterItemSet: a,
  /** @export */ DLR_CreateIntermediateResultUnits: a,
  /** @export */ DLR_CreateParameters: a,
  /** @export */ DLR_CreateRecognizedTextLinesResult: a,
  /** @export */ DLR_CreateTargetRoiDefConditionFilter: a,
  /** @export */ DLR_CreateTaskAlgEntity: a,
  /** @export */ DLR_CreateTextLineResultItem: a,
  /** @export */ DLR_ReadTaskSetting: a,
  /** @export */ DMImage_GetDIB: a,
  /** @export */ DMImage_GetOrientation: a,
  /** @export */ DNN_CreateSession: a,
  /** @export */ DNN_GetRegionByIndex: a,
  /** @export */ DNN_ReleaseRegion: a,
  /** @export */ DNN_ReleaseSession: a,
  /** @export */ DNN_RunDeblurInference: a,
  /** @export */ DNN_RunEan13Inference: a,
  /** @export */ DNN_RunLocalizationInference: a,
  /** @export */ DeleteDirectoryFetcher: a,
  /** @export */ _ZN14CodeParserWasm25getJvFromParsedResultItemEPKN9dynamsoft3dcp17CParsedResultItemE: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass12isSameResultEN4Json5ValueES2_: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass15clearVerifyListEv: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass22getDuplicateForgetTimeEv: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass22setDuplicateForgetTimeEi: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass25enableResultDeduplicationEb: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass26getJvFromBarcodeResultItemEPKN9dynamsoft3dbr18CBarcodeResultItemEPKcb: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClass29enableResultCrossVerificationEb: a,
  /** @export */ _ZN17BarcodeReaderWasm12DbrWasmClassC1Ev: a,
  /** @export */ _ZN17BarcodeReaderWasm23getJvFromBarcodeDetailsERK13BarcodeFormatPKN9dynamsoft3dbr15CBarcodeDetailsE: a,
  /** @export */ _ZN17BarcodeReaderWasm31getJvFromBarcodeResultItem_JustEPKN9dynamsoft3dbr18CBarcodeResultItemE: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass15clearVerifyListEv: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass22getDuplicateForgetTimeEi: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass22setDuplicateForgetTimeEii: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass25enableResultDeduplicationEib: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass29enableResultCrossVerificationEib: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass31getJvFromDetectedQuadResultItemEPKN9dynamsoft3ddn23CDetectedQuadResultItemEPKcb: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass32getJvFromDeskewedImageResultItemEPKN9dynamsoft3ddn24CDeskewedImageResultItemEPKcb: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClass32getJvFromEnhancedImageResultItemEPKN9dynamsoft3ddn24CEnhancedImageResultItemE: a,
  /** @export */ _ZN22DocumentNormalizerWasm12DdnWasmClassC1Ev: a,
  /** @export */ _ZN22DocumentNormalizerWasm36getJvFromDetectedQuadResultItem_JustEPKN9dynamsoft3ddn23CDetectedQuadResultItemE: a,
  /** @export */ _ZN22DocumentNormalizerWasm37getJvFromDeskewedImageResultItem_JustEPKN9dynamsoft3ddn24CDeskewedImageResultItemE: a,
...
var stringToUTF8OnStack = str => {
  ...
  var ret = __emscripten_stack_alloc(size);
  stringToUTF8(str, ret, size);
  return ret;
};
var loadDynamicLibrary = ()=>{}; // empty function
...
function run() {
  ...
  function doRun() {
    ...
    // In main_module/side_module, 
    // some funcs in wasmImports and some funcs in wasmExports.
    // In single wasm, all in wasmExports.
    wasmImports = wasmExports;
    
    _emscripten_bind_funcs(addFunction((a,b,c)=>{
    ...
    _emscripten_bind_funcs(addFunction((a,b,c,d)=>{
